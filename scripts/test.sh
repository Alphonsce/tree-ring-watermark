...
accelerate launch -m tree_ring_watermark.run_tree_ring_watermark_attack \
  --run_name test_vae_2020 --w_channel 3 --w_pattern ring --start 0 --end 10 --reference_model ViT-g-14 --reference_model_pretrain laion2b_s12b_b42k --num_inference_steps 5 \
  --with_tracking --use_attack --attack_type vae \
  --freq_log 2

# accelerate launch -m tree_ring_watermark.run_tree_ring_watermark_attack \
#   --run_name test_diff --w_channel 3 --w_pattern ring --start 0 --end 10 --reference_model ViT-g-14 --reference_model_pretrain laion2b_s12b_b42k --num_inference_steps 5 \
#   --with_tracking --use_attack \
#   --freq_log 2
